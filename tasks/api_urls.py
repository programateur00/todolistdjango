...
urlpatterns = [
    ...
    path("plans/language-options/", api.plan_language_options, name="plan_language_options"),
    path("plans/language-draft/", api.plan_language_draft, name="plan_language_draft"),
    path("plans/language-save/", api.plan_language_save, name="plan_language_save"),
