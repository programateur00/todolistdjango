...
urlpatterns = [
    ...
    path("<int:pk>/calentamiento/", views.task_warmup, name="task_warmup"),
    path("<int:pk>/enfriamiento/", views.task_cooldown, name="task_cooldown"),
    path("<int:pk>/calentamiento/circuito/<int:routine_pk>/", views.task_warmup_routine, name="task_warmup_routine"),
    path("<int:pk>/calentamiento/circuito/<int:routine_pk>/guardar/", views.task_warmup_routine_save, name="task_warmup_routine_save"),
    path("<int:pk>/enfriamiento/circuito/<int:routine_pk>/", views.task_cooldown_routine, name="task_cooldown_routine"),
    path("<int:pk>/enfriamiento/circuito/<int:routine_pk>/guardar/", views.task_cooldown_routine_save, name="task_cooldown_routine_save"),
    ...
    path("planes/nuevo/idioma/", views.plan_language_confirm, name="plan_language_confirm"),
