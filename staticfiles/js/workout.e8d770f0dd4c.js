...
class WorkoutSession {
  ...
  processPushupFront(lm, now) {
    ...
    if (this.state === null) {
      if (!standingLike && elbowAngle >= PUSHUPFRONT_ARM_GATE_DEG) {
